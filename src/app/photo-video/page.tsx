  ...
  return (
    <main className="text-white px-4 md:px-8 lg:px-12 pt-6 sm:pt-8 md:pt-12 pb-12 max-w-6xl mx-auto">
      ...
      <section className="mb-8 sm:mb-10 md:mb-12">
        <h2 className="text-2xl font-bold mb-3 sm:mb-3.5 md:mb-4">Latest from Instagram</h2>

        <IgWidget
          widgetId="cc9fe4cb06b254c8874b5446fa4a7a12"  
          height={600}                             
        />
      ...
      <section className="mb-8 sm:mb-10 md:mb-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
          {photos.map((f) => (
            <figure key={f} className="relative rounded-xl overflow-hidden bg-[#111]">
              <Image
